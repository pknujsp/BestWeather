...
import com.lifedawn.bestweather.commons.classes.*
...
import com.lifedawn.bestweather.ui.alert.AlertFragment
import com.lifedawn.bestweather.ui.findaddress.map.MapFragment
import com.lifedawn.bestweather.ui.flickr.FlickrViewModel
...
import com.lifedawn.bestweather.ui.weathers.detail.currentconditions.DetailCurrentConditionsFragment
...
import com.lifedawn.bestweather.ui.weathers.simple.aqicn.SimpleAirQualityFragment
import com.lifedawn.bestweather.ui.weathers.simple.currentconditions.SimpleCurrentConditionsFragment
import com.lifedawn.bestweather.ui.weathers.simple.dailyforecast.SimpleDailyForecastFragment
import com.lifedawn.bestweather.ui.weathers.simple.hourlyforecast.SimpleHourlyForecastFragment
import com.lifedawn.bestweather.ui.weathers.simple.sunsetrise.SunsetriseFragment
...
class WeatherFragment(private val iWeatherFragment: IWeatherFragment) : BaseFragment<FragmentWeatherBinding>(
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        asyncLayoutInflater.inflate(R.layout.fragment_weather, container, object : AsyncLayoutInflater.OnInflateFinishedListener {
            ...
            override fun onInflateFinished(view: View, resid: Int, parent: ViewGroup?) {
                ...
                binding!!.mainToolbar.find.setOnClickListener { v: View? ->
                    if (networkStatus.networkAvailable()) {
                        ...
                        mapFragment.setOnResultFavoriteListener(object : MapFragment.OnResultFavoriteListener {
    ...
    private val MY_LOCATION_CALLBACK: FusedLocation.MyLocationCallback = object : MyLocationCallback() {
        ...
        fun onFailed(fail: FusedLocation.Fail) {
            ...
            } else if (fail === FusedLocation.Fail.FAILED_FIND_LOCATION) {
                val btnObjList: MutableList<AlertFragment.BtnObj> = ArrayList<AlertFragment.BtnObj>()
                btnObjList.add(AlertFragment.BtnObj(View.OnClickListener { v: View? ->
                    val argument = Bundle()
    ...
    private fun processOnResult(responseResultObj: ResponseResultObj) {
        val entrySet: Set<Map.Entry<WeatherProviderType, ArrayMap<RetrofitClient.ServiceType, MultipleWeatherRestApiCallback.ResponseResult>>> =
    ...
    private fun setFailFragment(btnObjList: List<AlertFragment.BtnObj>) {
