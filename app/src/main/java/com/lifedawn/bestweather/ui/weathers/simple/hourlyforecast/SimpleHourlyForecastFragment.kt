package com.lifedawn.bestweather.ui.weathers.simple.hourlyforecast
...
import com.lifedawn.bestweather.ui.weathers.detail.base.BaseDetailHourlyForecastFragment.Companion.setHourlyForecastDtoList
import com.lifedawn.bestweather.ui.weathers.detail.hourlyforecast.DetailHourlyForecastFragment
import com.lifedawn.bestweather.ui.weathers.simple.base.BaseSimpleForecastFragment
...
class SimpleHourlyForecastFragment : BaseSimpleForecastFragment() {
    ...
    override fun setValuesToViews() {
        MyApplication.getExecutorService().submit {
            ...
            dateRow = DateView(context, WeatherDataType.Simple, viewWidth, columnWidth)
            val weatherIconRow = SingleWeatherIconView(
                context, WeatherDataType.Simple, viewWidth, weatherRowHeight,
                columnWidth
            )
            val probabilityOfPrecipitationRow = IconTextView(
                context, WeatherDataType.Simple, viewWidth,
