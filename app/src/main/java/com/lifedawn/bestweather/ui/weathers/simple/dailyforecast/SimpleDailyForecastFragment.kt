package com.lifedawn.bestweather.ui.weathers.simple.dailyforecast
...
import com.lifedawn.bestweather.ui.weathers.detail.base.BaseDetailDailyForecastFragment
import com.lifedawn.bestweather.ui.weathers.detail.dailyforecast.DetailDailyForecastFragment
    ...
    override fun setValuesToViews() {
        ...
        MyApplication.getExecutorService().submit {
            ...
            val weatherIconRow = DoubleWeatherIconView(
                context, WeatherDataType.Simple, VIEW_WIDTH, WEATHER_ROW_HEIGHT,
                COLUMN_WIDTH
            )
            val probabilityOfPrecipitationRow = IconTextView(
                context, WeatherDataType.Simple, VIEW_WIDTH,
            ...
            val tempRow = DetailDoubleTemperatureView(
                requireContext().applicationContext, WeatherDataType.Simple, VIEW_WIDTH,
