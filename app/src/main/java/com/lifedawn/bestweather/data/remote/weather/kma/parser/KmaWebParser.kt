package com.lifedawn.bestweather.data.remote.weather.kma.parser
...
class KmaWebParser {
    ...
    companion object {
        ...
        fun parseCurrentConditions(document: Document?, baseDateTime: String): ParsedKmaCurrentConditions? {
            ...
            return ParsedKmaCurrentConditions(
        ...
        fun makeExtendedDailyForecasts(
            ...
            while (beginIdx < hourlyForecasts.size) {
                ...
                if (hours == 0 && minTemp != Int.MAX_VALUE) {
                    ...
                    dailyForecasts.add(
                        ParsedKmaDailyForecast(
                            dateISO8601 = dateTime.toString(), amValues = ParsedKmaDailyForecast.Values(
                                pop = amPop,
                    ...
                    if (hours == 9) {
                        amSky = KmaResponseProcessor.convertHourlyWeatherDescriptionToMid(hourlyForecasts[beginIdx].weatherDescription)
                        amPop = hourlyForecasts[beginIdx].pop
                    } else if (hours == 15) {
                        pmSky = KmaResponseProcessor.convertHourlyWeatherDescriptionToMid(hourlyForecasts[beginIdx].weatherDescription)
