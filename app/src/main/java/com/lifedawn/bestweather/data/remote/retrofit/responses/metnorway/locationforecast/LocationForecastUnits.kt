...
class LocationForecastUnits {
    ...
    @Expose @SerializedName("precipitation_amount_max") var precipitationAmountMax: String? = null
    @Expose @SerializedName("precipitation_amount_min") var precipitationAmountMin: String? = null
    @Expose @SerializedName("probability_of_precipitation") var probabilityOfPrecipitation: String? = null
    @Expose @SerializedName("probability_of_thunder") var probabilityOfThunder: String? = null
    ...
    @Expose @SerializedName("wind_speed_of_gust") var windSpeedOfGust: String? = null
}