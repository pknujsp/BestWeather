...
public class SecondWidgetJobService extends AbstractWidgetJobService {
	@Override
	...
	@Override
	SecondWidgetCreator createWidgetViewCreator(int appWidgetId, int jobId) {
		SecondWidgetCreator secondWidgetCreator = new SecondWidgetCreator(getApplicationContext(), null, appWidgetId);
		widgetCreatorMap.put(jobId, secondWidgetCreator);
		return secondWidgetCreator;
	}
	...
	protected void setResultViews(Context context, int appWidgetId, RemoteViews remoteViews, WidgetDto widgetDto, Set<WeatherDataSourceType> requestWeatherDataSourceTypeSet, @Nullable @org.jetbrains.annotations.Nullable MultipleRestApiDownloader multipleRestApiDownloader, Set<RequestWeatherDataType> requestWeatherDataTypeSet, int jobId) {
		...
		SecondWidgetCreator widgetCreator = (SecondWidgetCreator) widgetCreatorMap.get(jobId);
