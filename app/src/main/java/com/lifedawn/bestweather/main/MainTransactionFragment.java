...
public class MainTransactionFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		fragmentManager.setFragmentResultListener(getString(R.string.key_back_from_favorite_to_main), this, new FragmentResultListener() {
			@Override
			public void onFragmentResult(@NonNull @NotNull String requestKey, @NonNull @NotNull Bundle result) {
				//변경된 위치가 있는지 확인
				List<FavoriteAddressDto> newFavoriteAddressDtoList = (List<FavoriteAddressDto>) result.getSerializable(
						getString(R.string.bundle_key_new_favorite_address_list));
	...
	private void processIfPreviousFragmentIsFavorite(Bundle bundle) {
		final int lastSelectedFavoriteAddressId = Integer.parseInt(
				sharedPreferences.getString(getString(R.string.bundle_key_new_favorite_address_dto_id), "-1"));
		final LocationType lastSelectedLocationType = LocationType.enumOf(
