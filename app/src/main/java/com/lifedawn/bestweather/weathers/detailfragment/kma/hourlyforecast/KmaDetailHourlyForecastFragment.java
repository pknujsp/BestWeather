...
public class KmaDetailHourlyForecastFragment extends BaseDetailForecastFragment {
	...
	public void setValuesToViews() {
		...
		addLabelView(R.drawable.temp_icon, getString(R.string.fresh_snow_cover), defaultTextRowHeight);
		addLabelView(R.drawable.temp_icon, getString(R.string.thunderstorm), defaultTextRowHeight);
