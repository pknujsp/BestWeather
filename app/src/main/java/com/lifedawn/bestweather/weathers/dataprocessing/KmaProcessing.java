...
public final class KmaProcessing {
	 ...
	 * 초단기 실황
	 */
	public static Call<JsonObject> getUltraSrtNcstData(UltraSrtNcstParameter parameter, Calendar calendar,
	 ...
	 * 초단기예보
	 */
	public static Call<JsonObject> getUltraSrtFcstData(UltraSrtFcstParameter parameter, Calendar calendar,
			JsonDownloader<JsonObject> callback) {
	 ...
	 */
	public static Call<JsonObject> getVilageFcstData(VilageFcstParameter parameter, Calendar calendar,
			JsonDownloader<JsonObject> callback) {
	...
	public static void getKmaForecasts(KmaAreaCodeDto nearbyKmaAreaCodeDto, MultipleJsonDownloader<JsonObject> multipleJsonDownloader) {
		...
		Call<JsonObject> ultraSrtNcstCall = getUltraSrtNcstData(ultraSrtNcstParameter, (Calendar) calendar.clone(), kmaVilageFcstCallback);
		
		Call<JsonObject> ultraSrtFcstCall = getUltraSrtFcstData(ultraSrtFcstParameter, (Calendar) calendar.clone(), kmaVilageFcstCallback);
