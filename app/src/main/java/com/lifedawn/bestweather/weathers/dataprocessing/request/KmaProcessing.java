...
public final class KmaProcessing {
	...
	public static void getKmaForecasts(KmaAreaCodeDto nearbyKmaAreaCodeDto, MultipleJsonDownloader<JsonElement> multipleJsonDownloader) {
		...
		Call<JsonElement> ultraSrtNcstCall = getUltraSrtNcstData(ultraSrtNcstParameter, (Calendar) calendar.clone(), new JsonDownloader<JsonElement>() {
			@Override
		...
		Call<JsonElement> ultraSrtFcstCall = getUltraSrtFcstData(ultraSrtFcstParameter, (Calendar) calendar.clone(), new JsonDownloader<JsonElement>() {
			@Override
			public void onResponseResult(Response<? extends JsonElement> response) {
		...
		Call<JsonElement> vilageFcstCall = getVilageFcstData(vilageFcstParameter, (Calendar) calendar.clone(), new JsonDownloader<JsonElement>() {
			@Override
			public void onResponseResult(Response<? extends JsonElement> response) {
