...
public class SunsetriseFragment extends Fragment implements IWeatherValues {
	...
	public static class TimeLineView extends View {
		...
		public TimeLineView(Context context) {
			...
			currentTimeTextPaint = new TextPaint(Paint.ANTI_ALIAS_FLAG);
			currentTimeTextPaint.setColor(Color.WHITE);
		...
		private Point[] drawTimeLine(Canvas canvas) {
			Point[] linePoints = new Point[2];
			Rect rect = new Rect();
			String tempStr = "10.10 Mon 06:00";
			currentTimeTextPaint.getTextBounds(tempStr, 0, tempStr.length(), rect);
