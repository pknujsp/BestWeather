...
public class AccuSimpleDailyForecastFragment extends BaseSimpleForecastFragment {
	...
	public void setValuesToViews() {
		...
		DoubleWeatherIconView weatherIconRow = new DoubleWeatherIconView(context, FragmentType.Simple, viewWidth, WEATHER_ROW_HEIGHT,
				columnWidth);
		TextValueView probabilityOfPrecipitationRow = new TextValueView(context, FragmentType.Simple, viewWidth, DEFAULT_TEXT_ROW_HEIGHT,
				columnWidth);
		TextValueView precipitationVolumeRow = new TextValueView(context, FragmentType.Simple, viewWidth, DEFAULT_TEXT_ROW_HEIGHT,
				columnWidth);
