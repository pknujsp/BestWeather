...
public class HourlyForecastDto implements Serializable {
	...
	private boolean hasNext6HoursPrecipitation;
	...
	public HourlyForecastDto setHasNext6HoursPrecipitation(boolean hasNext6HoursPrecipitation) {
		this.hasNext6HoursPrecipitation = hasNext6HoursPrecipitation;
		return this;
	}
